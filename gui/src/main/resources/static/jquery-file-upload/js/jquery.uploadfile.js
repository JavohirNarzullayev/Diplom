...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.showQueueDiv)
                    ...
                    obj.container = $("<div class='ajax-file-upload-container col-md-6 col-sm-6 col-xs-12 col-md-offset-3' style='padding-left: 0px;'></div>").insertAfter($(obj));
        ...
        this.createProgress = function (id,name,path,size) {
            ...
            if(s.showFileCounter)
                fileNameStr = obj.fileCounter + s.fileCounterStyle + name;
            else fileNameStr = name;


            if(s.showFileSize)
                fileNameStr += " ("+getSizeStr(size)+")";
            ...
            pd.name=fileNameStr;
            console.log(pd.name);
            /*pd.name.html(fileNameStr);*/
            obj.fileCounter++;
            obj.selectedFiles++;
            if(s.showPreview)
            {
                pd.preview.attr('src',path);
                pd.preview.show();
            }
            ...
            if(s.showDownload) {
                ...
                pd.download.click(function () {
                    if(s.downloadCallback) s.downloadCallback.call(obj, [id], pd);
                });
            }
            if(s.showDelete)
            {
        ...
        function defaultProgressBar(obj,s)
        {
            ...
            this.statusbar = $("<div class='ajax-file-upload-statusbar' style='width: 100%;margin-left: 0px;'></div>").width(s.statusBarWidth);
